...
@section('content')
    <div class="row" ng-controller="MainController" show-loader="state.loadingVendorCategories">
        <div class="col-sm-12">
            ...
            <div class="box">
                <bulk-assigner target="vendorCategories" url="/vendor-category/bulk-edit">
                ...
                <div class="box-options">
                    <a href="javascript:void(0)" class="box-option"
                       ng-if="vendorCategories.length">
                        <i to-csv="vendorCategories"
                           csv-file-name="vendorCategories.csv"
                           csv-fields="csvFields"
                           class="fa fa-download"
                           uib-tooltip="Download data as CSV"
                           tooltip-placement="left"></i>
                    </a>&nbsp;
                    <a href="javascript:void(0)" ng-click="loadVendorCategories()" class="box-option">
