            ...
            <table class="table table-bordered table-hover grid-view-tbl">
                <tr class="search-row">
                    <td>
                        ...
                        <input ng-model="startDate" id="startDate" class="form-control" moment-picker="start"
                               format="YYYY-MM-DD" min-view="month" max-view="month">
                    </td>
                    <td>
                        <label>End Date</label>
                        <input ng-model="endDate" id="endDate" class="form-control"
                               moment-picker="end"  format="YYYY-MM-DD"></td>
                    <td style="padding-top: 32px;">
                        <button class="btn btn-primary btn-flat" ng-click="showProductsReport(startDate,endDate)">
                            Generate Report
                        </button>
                    </td>
                </tr>
